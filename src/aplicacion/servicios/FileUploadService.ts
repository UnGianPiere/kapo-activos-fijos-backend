...
export class FileUploadService {
  ...
  static async uploadGraphQLFile(
    ...
    try {
      ...
      const fileName = config.generateUniqueNames !== false
   ...
   */
  static get EVIDENCIAS_CONFIG(): FileUploadConfig {
    return {
  ...
  static get DOCUMENTOS_CONFIG(): FileUploadConfig {
    return {
  ...
  static get EVIDENCIAS_REPORTES_ACTIVOS_FIJOS_CONFIG(): FileUploadConfig {
    return {
      folder: "evidencias/activos-fijos/reportes",
      maxFileSize: 10 * 1024 * 1024, // 10MB
      allowedMimeTypes: [
        "image/jpeg", "image/png", "image/webp", "image/gif",
